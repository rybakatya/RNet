...
namespace RapidNet.Threading.LocklessQueue
{
    internal static partial class HashHelpers
    {
        ...
        internal const int MaxPrimeArrayLength = 0x7FFFFFC3;
        internal const int MaxArraySize = 0X7FFFFFC7;
        ...
        internal static int ExpandPrime(int oldSize)
        {
            ...
            {
                System.Diagnostics.Debug.Assert(MaxPrimeArrayLength == GetPrime(MaxPrimeArrayLength), "Invalid MaxPrimeArrayLength");
